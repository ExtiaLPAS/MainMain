...
import { View, FlatList, ImageBackground, StyleSheet, Text, Image} from 'react-native';
...
class HomePage extends React.Component {
    ...
    render(){
        return(
            ...
            <View style={{ flex: 1,borderRadius: 100,backgroundColor : 'white' , marginBottom : 50, padding: 0, marginTop : 30, width : 300, height: 80, alignItems: 'center', marginLeft: 'auto', marginRight: 'auto'}} >
                <Image
