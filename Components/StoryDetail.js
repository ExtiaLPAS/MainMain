...
import anim from '../assets/21575-sound-wave-animation.json'
    ...
    render() {
        ...
        return(
           ...
           <View style={{ backgroundColor : '#caaffe' }} >            
            <View style={{borderBottomRightRadius: 45 ,borderBottomLeftRadius: 45, borderRadius: 0, backgroundColor: 'white'}}  >            
                ...
                <View style={{flexDirection:'row', marginTop : -25}}>
                    <View style={styles.shadow_title} >
                     ...
                     <Icon color='#7158B6' size={30} name='heart' ></Icon>
                     </View>
                </View>
                ...
                <View style={{ marginTop: -40, marginBottom : 20, justifyContent: 'center', alignItems: 'center'}} >
                   <AirbnbRating reviews size={30} ></AirbnbRating>
                   <Animation
                        ref={animation => {
                ...
                <View style={{flexDirection:'row',flex :1, justifyContent : "center", marginLeft: 'auto', marginRight:'auto', padding:1}}>

                    <View style={{ marginTop: 10,right: 50, alignItems: "center",transform:[{scaleX: "-1"},]}}>
                        <Icon color='black' size={30} name='forward' ></Icon>
                    </View>

                    <View style={{ justifyContent: "center", alignItems: "center"}}>
                        <View style={styles.shadow_title} >
                            <Icon reverse color='#caaffe' size={70} name='play' ></Icon>
                        </View>    
                    </View>
                ...
                <View style={{ flexDirection: 'row'}} >
                    ...
                    <View style={{marginLeft: 30, marginTop : 5}}>
                        <Icon color='#7158B6' size={30} name='sound' ></Icon>
                    </View>        

                <View style={{ flex: 1, alignItems: 'stretch', justifyContent: 'center', marginLeft: 20, marginRight :30, marginBottom: 30 }}>
                    <Slider
